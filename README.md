...
### Тесты добавления книг
    ...
    - тест метода add_new_book с двумя одинакомвыми книгами
    - тест метода add_new_book с валидными именами (с применением параметризации)
...
### Тесты со списком Избранных книг
    ...
    - тест метода add_book_in_favorites с добавлением книги которая не была добавлена в коллекцию
